	...
	<view class="shop-page">
		<view class="search-bar">
			<view class="search-input-wrapper">
				<input class="search-input" type="text" placeholder="搜索全站商品" v-model="keyword" @confirm="handleSearch" :adjust-position="false" :hold-keyboard="false" />
			</view>
		...
		<scroll-view scroll-y class="product-scroll" :style="{ height: scrollHeight + 'px' }" @scrolltolower="loadMore">
...
<script>
import { getProductList, getCategoryList } from '@/api/pet/mall.js';
